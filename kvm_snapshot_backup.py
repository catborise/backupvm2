...
if __name__ == "__main__":
    ...
    backup_parser.add_argument('-H', '--host', dest='host_ip', required=True)
    ...
    try:
        ...
        src_uri = 'qemu+tcp://' + command_args.host_ip + '/system'
        connection = Connection(src_uri, src_sasl_user, src_sasl_pass)
        app_libvirt_conn = connection.connect()
